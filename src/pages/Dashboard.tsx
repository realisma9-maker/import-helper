  ...
  return (
    <>
      ...
      <div className="flex h-screen bg-app-gradient overflow-hidden relative">
        ...
        {/* FIX: Floating Filter Button for Mobile - Always Visible */}
        <Button
          variant="outline"
          size="icon"
          onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
          className={`fixed top-3 left-3 z-50 w-10 h-10 rounded-lg shadow-lg md:hidden transition-all duration-300 ${!sidebarCollapsed ? 'bg-primary text-primary-foreground border-primary' : 'bg-background/90 backdrop-blur-md border-border'}`}
        >
        ...
        {!sidebarCollapsed && (
          <div className="fixed inset-0 bg-black/60 z-40 md:hidden backdrop-blur-sm" onClick={() => setSidebarCollapsed(true)} />
        )}
